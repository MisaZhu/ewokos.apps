...
bool Init680x0(void)
{
	...
	switch (ROMVersion) {
		...
		case ROM_VERSION_II:
			...
			break;
		case ROM_VERSION_32:
			// In 24-bit addressing mode a 32-bit clean ROM is visible at
			// 0x400000 (like on a real Mac IIci running 24-bit), and the
			// rom24/frame24 banks mask addresses to 24 bits
			ROMBaseMac = TwentyFourBitAddressing ? 0x00400000 : 0x40800000;
			break;
		default:
			return false;
	}
