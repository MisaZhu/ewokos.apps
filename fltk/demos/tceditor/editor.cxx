...
// EwokOS port: the vendored FLTK is 1.1.11, which has no
// Fl_Text_Display::wrap_mode() / WRAP_* enums (added in FLTK 1.3), so the
// word-wrap menu option is disabled here.
// #define ENA_LINEWRAP

// EwokOS port: FLTK 1.1.11 has no Fl_Text_Editor::linenumber_width() /
// linenumber_font() / linenumber_size() (added in FLTK 1.3), so the
// line-numbers menu option is disabled here.
// #define ENA_LINENUMS
